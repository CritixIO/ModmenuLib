...
namespace ModmenuLib
{
    ...
    {
        public void Key_Left(object sender, KeyEventArgs e)
        {
            ...
            if (Menu.Get.Page[Menu.Get.WasOnPage].Items[OnItem_Index].FunctionType == 2)
            {
                ...
                if (index -1 >= 0) { Menu.Get.Page[Menu.Get.WasOnPage].Items[OnItem_Index].Function2_SelectedValue = values[index - 1]; }
                //Redraw
                Menu.Get.Redraw();
            }
        }
